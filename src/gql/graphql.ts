...
export type GenerateSignedPostOptionUrlMutation = { __typename?: 'Mutation', generateSignedPostOptionUrl: { __typename?: 'GenerateSignedPostOptionUrlPayload', url: string, bucketName: string, errors: Array<{ __typename?: 'UnauthenticatedError', message: string } | { __typename?: 'UnsupportedFileTypeError', message: string }> } };
